...
const Welcome = () => {
    return (
        <div onContextMenu={(e) => e.preventDefault()} className="flex-1/3 bg-[#dee1ff] dark:bg-[#131313] text-black dark:text-white flex flex-col justify-center items-center text-center">
