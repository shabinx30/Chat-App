...
const Welcome = () => {
    ...
    return (
        <div
            ...
            className="relative select-none hidden md:flex flex-[calc(1/2.6*100%)] bg-[#dee1ff] dark:bg-gray-950 text-black dark:text-white flex-col justify-center items-center text-center"
        >
