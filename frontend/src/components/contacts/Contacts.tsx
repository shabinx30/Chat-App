...
const Contacts = ({ change, setPop, setSett }: AddContactType) => {
    ...
    return (
        <section
            className={`${
                chatId ? "hidden md:block md:min-w-[30.8%] md:max-w-[60%]" : "flex-1"
            } bg-[#ffffff] h-[100vh] relative md:overflow-auto md:resize-x dark:bg-gray-900 text-black dark:border-r border-[#282828]`}
        >
